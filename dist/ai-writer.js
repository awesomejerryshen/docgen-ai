...
function generateBadges(pkgName, repo, license, badges) {
...
function fallbackReadme(structure, badges, sections) {
...
function fallbackApiDocs(structure) {
